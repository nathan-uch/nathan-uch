    ...
    return (
        <div class="page-section bg-gray-200 relative flex flex-col justify-center items-center min-h-screen w-full py-8 text-pri-dark">
            <div class="text-center text-xl md:text-2x">
                <h2 class="w-3/4 mx-auto my-5 text-5xl md:text-6xl xl:text-7xl font-bold">About Me</h2>
                ...
                <div class="relative group flex flex-col justify-center items-center my-8 gap-8 text-xl md:text-2x">
                    ...
                    <div class="w-3/4">I like searching for solutions through observing details and testing. Software engineering can sometimes feel like a great puzzle that makes time fly. The satisfaction of finding and coming up with a way to fix or improve makes the process so enjoyable. There are so many paths to a solution!</div>
                    <div class="text-xs md:text-base absolute -bottom-14 left-0 right-0 opacity-0 -translate-y-2 group-hover:translate-y-0 group-hover:opacity-100 transition-all ease-in-out duration-300">
